...
\begin{itemize}[noitemsep,topsep=0pt]
    \item Build optimizer to optimize multi-strategy trading portfolio with risk management and constraints.
    \item Set up software and tools to provide fast access to tools and data for discretionary tradings.
